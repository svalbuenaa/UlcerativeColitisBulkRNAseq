...
imputed_cibersortx_long <- pivot_longer(imputed_cibersortx, cols = colnames(imputed_cibersortx[2:ncol(imputed_cibersortx)]), names_to = "Cell_Type", values_to = "Relative_Fraction")
...
text_1 <- data.frame(matrix(nrow = 1, ncol = 3))
colnames(text_1) <- c("x", "Cell_Type", "text")
text_1[,1] <- 12
text_1[,2] <- 2
text_1[,3] <- "Non-inflamed"
